"""
Django settings for gardensketch project.
...
ALLOWED_HOSTS = [ "localhost", "gardenplaner.local"]
...
ROOT_URLCONF = 'gardensketch.urls'
...
WSGI_APPLICATION = 'gardensketch.wsgi.application'
